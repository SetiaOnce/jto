...
class LprBlue(models.Model):
    id = models.AutoField(primary_key=True)
    # ----------------------------------------------------
    # RELATION
    # ----------------------------------------------------
    timbangan = models.ForeignKey(
        'MasterTimbangan',
        on_delete=models.CASCADE,
        db_column='timbangan_id',
        related_name='lpr_blue'
    )
    is_found = models.CharField(max_length=1, null=True, blank=True)
